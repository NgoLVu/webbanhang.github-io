...
--
-- Máy ch?: 127.0.0.1
-- Th?i gian ð? t?o: Th1 19, 2023 lúc 03:32 AM
-- Phiên b?n máy ph?c v?: 10.4.24-MariaDB
-- Phiên b?n PHP: 7.4.29
...
--
-- Cõ s? d? li?u: `id17735524_webbanhang`
--
...
--
-- Ðang ð? d? li?u cho b?ng `category`
--

INSERT INTO `category` (`id`, `name`) VALUES
(15, 'H?i s?n khô'),
(16, 'H?i s?n ð? ch? bi?n'),
(17, 'H?i s?n týõi s?ng');

-- --------------------------------------------------------

--
-- C?u trúc b?ng cho b?ng `feedback`
--
...
--
-- Ðang ð? d? li?u cho b?ng `feedback`
--
...
--
-- C?u trúc b?ng cho b?ng `order_details`
--
...
--
-- Ðang ð? d? li?u cho b?ng `order_details`
--
...
--
-- Ðang ð? d? li?u cho b?ng `product`
--
...
(19, 15, 'M?c khô', 1200000, 1200000, 'assets/photos/download (1).jpg', '', '2021-11-04 05:17:04', '2021-11-04 16:58:07', 0),
(20, 15, 'Cá m?i khô', 0, 150000, 'assets/photos/cach-lam-kho-ca-moi-ngon-don-gian-tai-nha-202109301110338463.jpg', '', '2021-11-04 16:57:03', '2021-11-04 16:57:03', 0),
(21, 15, 'Cá cõm khô', 80000, 80000, 'assets/photos/download (2).jpg', '', '2021-11-04 16:31:10', '2021-11-04 16:31:10', 0),
(22, 15, 'Cá ch? vàng', 0, 100000, 'assets/photos/ca_chi_vang_.jpg', '', '2021-11-04 16:44:11', '2021-11-04 16:44:11', 0),
(23, 17, 'Cá h?i', 300000, 300000, 'assets/photos/anh cahoi2.jpg', '', '2021-11-04 16:41:15', '2021-11-04 16:41:15', 0),
(24, 17, 'm?c lá', 0, 3000000, 'assets/photos/download.jpg', '', '2021-11-05 03:58:42', '2021-11-05 03:58:42', 0),
(25, 17, 'm?c ?ng', 400000, 400000, 'assets/photos/download (3).jpg', '', '2021-11-05 03:58:43', '2021-11-05 03:58:43', 0),
(26, 17, 'S?a', 100000, 100000, 'assets/photos/ngo-doc-sua-bien-2-1519777161415123139991-1200x676.jpg', '', '2021-11-05 03:26:45', '2021-11-05 03:26:45', 0),
...
(30, 17, 'Cá ng?', 80000, 80000, 'assets/photos/download (6).jpg', '', '2021-11-05 03:11:57', '2021-11-05 03:11:57', 0),
(31, 16, 'Cá h?i ðóng h?p', 50000, 50000, 'assets/photos/download (7).jpg', '', '2021-11-05 04:23:10', '2021-11-05 04:23:10', 0);

-- --------------------------------------------------------

--
-- C?u trúc b?ng cho b?ng `role`
--
...
--
-- Ch? m?c cho b?ng `category`
--
ALTER TABLE `category`
  ADD PRIMARY KEY (`id`);

--
-- Ch? m?c cho b?ng `feedback`
--
ALTER TABLE `feedback`
  ADD PRIMARY KEY (`id`);

--
-- Ch? m?c cho b?ng `galery`
--
ALTER TABLE `galery`
  ADD PRIMARY KEY (`id`),
...
--
-- Ch? m?c cho b?ng `role`
--
ALTER TABLE `role`
  ADD PRIMARY KEY (`id`);

--
-- Ch? m?c cho b?ng `tokens`
--
ALTER TABLE `tokens`
...
--
-- Các ràng bu?c cho các b?ng ð? ð?
--

--
-- Các ràng bu?c cho b?ng `galery`
--
ALTER TABLE `galery`
